      ...
      <div className="bg-gray-50 border-b border-gray-100 px-3 sm:px-4 py-1.5">
        <div className="max-w-7xl mx-auto">
          <a
            ...
            className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-3 sm:px-4 py-1.5 rounded-full transition-colors font-medium text-xs sm:text-sm"
          >
