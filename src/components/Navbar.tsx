...
export default function Navbar({ isAdmin, onUserClick, siteName, logoUrl, logo2Url }: NavbarProps) {
    ...
    <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
      ...
      <div className="bg-gray-50 border-b border-gray-100 px-4 py-1.5">
        <div className="max-w-7xl mx-auto">
          <a
            href="https://wa.me/528681240714"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-4 py-1.5 rounded-full transition-colors font-medium text-sm"
          >
